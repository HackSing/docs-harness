...
- 资产指纹：`sha256:0a7d63a62a3ab3279f49ec28ecf9cebac67e93577c76cc310d3d424485e7d657`

## 摘要

2.7.0 对 Plan、Knowledge、Acceptance 建立统一检查、反向关系和分层提交防线；2.8.0 新增 ADR 第四类受管资产与项目级文档脚手架/检查。

## 事实

### `assets.check.execution`

assets-check 聚合四类资产与跨资产关系；pre-commit 使用 fast，GitHub CI 使用 strict。
